...
@WebServlet("/announcement/edit.do")
public class EditController extends HttpServlet
{
			...
			throws ServletException, IOException 
	{
		...
		req.getRequestDispatcher("/announcement/Edit.jsp").forward(req, resp);
	}
			...
			throws ServletException, IOException 
	{
		...
		if(result == 1)
		{
			...
			resp.sendRedirect("../announcement/view.do?idx=" + idx); 
		}
		else
		{
			JSFunction.alertLocation(resp, "비밀번호 검증을 다시 진행해주세요", 
					"../announcement/view.do?idx=" + idx);
		}
	}
}
